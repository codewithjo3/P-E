        ...
        <div class="col-xl-12 d-flex align-items-center">
          ...
          <nav class="col-xl-12 nav-menu d-none d-lg-block">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              ...
              <li class="active"><a href="/workerhome">Home</a></li>
                ...
                <!-- <li><form action="status" method="post">
                {{csrf_field()}}
                <button>Status</button><label class="form-switch">
              ...
              <img src="{{ URL::asset('assets/worker_img/'.$data['Filepath']) }}" class="rounded-circle" width="50" height="50" alt="logo">
