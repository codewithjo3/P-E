            ...
            <div class="row">
                <div class="booking-form" >
                    ...
                    {{csrf_field()}}
                        ...
                        <input type="hidden" class="form-control" name="cusid" value="{{ $user['id'] }}">
                       ...
                       <option>{{$category->Category }}</option>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group"> <input name="date" class="form-control" type="date" >Date</span> </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group"> <input name="time" class="form-control" type="text" >Time</span> </div>
                            </div>
                            
                           
                        </div>
                        
                        <div class="form-btn"> <button class="submit-btn">Next</button> </div>
