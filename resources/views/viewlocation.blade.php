...
<section id="location" style="background-image: url(assets/img/intro-carousel/viewworker.jpg)">
            ...
            <table class="table table-striped table-hover" id="example">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                        <a class="btn btn-dark" href={{"/editlocation/".$location->id}}>EDIT</a>
                        <a class="btn btn-dark" href={{"/deletelocation/".$location->id}}>DELETE</a>  
                        </td>
                        </tr> @endforeach
                    </tr>
                </tbody>
