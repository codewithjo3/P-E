...
<section id="editcategory" style="background-image: url(../assets/img/intro-carousel/viewcat.jpg)">
      ...
      <br>
        ...
        <form action="/categoryeditprocess/{{ $categoryview->id }}" method="post">
...
<tr>
    ...
    <select value="{{$categoryview->category}}" name="category" id="category" class="form-control" >
 ...
 <tr>
     <td><input value="{{$categoryview->Payment}}" name="payment" type="text" class="form-control"></td>
 </tr>
