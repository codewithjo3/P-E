    ...
    <div class="table-responsive">
        <div>
            ...
            <thead>
                ...
                <tbody>
                <tr>
                        <td>@foreach($categoryview as $category)
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-dark" href={{"/editcategory/".$category->id}}>EDIT</a>
                            <a class="btn btn-dark" href={{"/deletecategory/".$category->id}}>DELETE</a>
                        </td>
                        </tr> @endforeach
                </tbody>
            </table>
